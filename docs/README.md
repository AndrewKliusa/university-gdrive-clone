# Photo Drive Website
A personal <ins>**photo**</ins> organizer. The owner uploads photos, groups them into <ins>**albums**</ins> (e.g. Wedding, Honeymoon), and tags <ins>**people**</ins> who appear in each photo (e.g. Mother, Sister). The app shows a list of photos, filterable by album or person, with summary stats (photo count, total size, date range) per album and per person.
<br>
<br>
